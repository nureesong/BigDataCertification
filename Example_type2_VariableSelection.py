...
print(f'MLP Accuracy: {round(mlp.score(X_train, y_train),4)}')
...
print(f'RandomForest Accuracy: {round(rf.score(X_train, y_train),4)}')
...
- MLP 모델의 예측값은 거의 0이다. 성능이 좋지 않은 것으로 보이므로 모델 선택에서 제외한다.
